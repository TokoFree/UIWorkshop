...
internal class OverlayLayoutVC: ASDKViewController<ASDisplayNode> {
    ...
    private var overlayOpacity: CGFloat = 0.2
    ...
    internal override init() {
        ...
        node.layoutSpecBlock = { [weak self] _, size -> ASLayoutSpec in
            ...
            let overlay = ASOverlayLayoutSpec(child: self.textNode, overlay: self.overlayNode)
    ...
    internal func setOpacity(val: CGFloat) {
        overlayNode.backgroundColor = UIColor.cyan.withAlphaComponent(val)
    }
